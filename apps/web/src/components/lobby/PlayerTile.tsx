  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: isYou ? 'var(--color-primary)' : 'var(--color-table-felt)',
      ...
      <span
        ...
        style={{ fontFamily: 'var(--font-fredoka)', color: isYou ? 'var(--color-primary)' : '#f1f5f9' }}
      >
        {player.displayName}
      ...
      {/* Host crown */}
      {isHost && (
        <Crown size={16} style={{ color: 'var(--color-flip7-gold)', flexShrink: 0 }} />
      )}
