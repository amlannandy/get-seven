...
export default function GameOverScreen({ winnerId, winnerName, finalScores, playerNames }: Props) {
      ...
      >
        ...
        {sorted.map(([pid, score], i) => (
          <div
            ...
            style={{ background: pid === winnerId ? 'rgba(251,191,36,0.1)' : 'transparent' }}
          >
            <span
            ...
            <span
              ...
              style={{ fontFamily: 'var(--font-fredoka)', color: pid === winnerId ? 'var(--color-flip7-gold)' : '#f1f5f9' }}
            >
              {playerNames[pid] ?? pid}
            </span>
            <span
